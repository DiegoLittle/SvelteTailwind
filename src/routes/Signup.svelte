<script>
  import { fireAuth } from "../plugins/auth.js";
        ...
        <div class="flex content-center items-center justify-center h-full">
          <div class="w-full lg:w-4/12 px-4">
            <div
              ...
              shadow-lg rounded-lg bg-gray-600 border-0">
              ...
              <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                ...
                <form>
                  <div class="relative w-full mb-3">
                    <label
                      class="block uppercase text-gray-200 text-xs font-bold
                      mb-2"
                      for="grid-password">
                      Email
                    </label>
                    <input
                      ...
                      bind:value={email}
                      type="email"
                      class="px-3 py-3 placeholder-gray-600 text-gray-700
